classdef ShakerGeoSectioned < models.muscle.AMuscleConfig
    ...
    methods
        function this = ShakerGeoSectioned(varargin)
...
%                     end
    ...
    methods(Access=protected)
        ...
        function geo = getGeometry(this)
            ...
            ypoints = ypoints(1:length(ypoints)/2);
            geo = fem.geometry.Belly(ypoints,'Radius',this.radfun,'InnerRadius',0, 'Half', true);
        end
